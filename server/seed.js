...
const users = [
    { name: 'Admin User', email: 'admin@venuvo.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@venuvo.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@venuvo.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@venuvo.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@venuvo.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@venuvo.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@venuvo.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@venuvo.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@venuvo.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@venuvo.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@venuvo.com');
        console.log('User Email:  user@venuvo.com');
